...
bin/t85play: bin bin/libt85apu.a emu/t85play.cpp emu/NotchFilter.cpp emu/BitConverter.cpp
	g++ -g -O2 -c emu/t85play.cpp -o bin/t85play.o
	g++ -g -o bin/t85play -L bin bin/t85play.o -lt85apu -lsndfile -lsoundio

bin:
	mkdir bin

bin/libt85apu.o: emu/ATtiny85APU.h emu/ATtiny85APU.c 
	gcc -O2 -std=c99 -c emu/ATtiny85APU.c -lm -o bin/libt85apu.o

bin/libt85apu.a: bin/libt85apu.o
